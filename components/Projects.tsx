...
const projects = [
  ...
  },
  {
    ...
    category: 'Mobile App',
    title: 'Retouch',
    desc: 'AI Object Remover App — intelligently erase unwanted objects, people, or blemishes from photos with a single tap.',
  ...
  },
  {
    ...
    title: 'dailyWin',
    desc: 'Habit Tracker App — build winning streaks with a clean, motivating interface designed to keep you consistent every day.',
