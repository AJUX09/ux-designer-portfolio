...
const apps = [
  ...
  },
  {
    ...
    stats: [{ label: 'Users', value: '50K+' }, { label: 'Rating', value: '4.7★' }, { label: 'Platform', value: 'Web & iOS' }],
    playstore: null,
    appstore: 'https://apps.apple.com',
  ...
  },
  {
    ...
    stats: [{ label: 'Users', value: '80K+' }, { label: 'Rating', value: '4.8★' }, { label: 'Platform', value: 'Web & iOS' }],
    playstore: null,
    appstore: 'https://apps.apple.com',
          ...
          {apps.map((app) => (
            ...
            >
              ...
              <div className="app-card-header">
                <div className="app-icon-wrap" style={{ borderColor: app.accentBorder }}>
